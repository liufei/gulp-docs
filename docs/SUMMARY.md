...
* [Recipes](recipes/README.md)
  ...
  * [Browserify + Globs (multiple destination)](recipes/browserify-multiple-destination.md)
  ...
  * [Run Grunt Tasks from Gulp](recipes/run-grunt-tasks-from-gulp.md)
  * [Exports as tasks](recipes/exports-as-tasks.md)
  * [Rollup with rollup-stream](recipes/rollup-with-rollup-stream.md)
